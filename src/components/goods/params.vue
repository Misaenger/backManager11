<template>
  ...
  <div>
    ...
    <el-card>
      ...
      <!-- 警告提示 -->
      <el-alert title="注意：只允许为第三级分类设置相关参数！" type="warning" :closable="false" show-icon center>
      </el-alert>
      <!-- 分类选择区域 -->
      <el-row>
        <el-col>
      ...
      <el-tabs v-model="activeName" @tab-click="handleTabClick">
        ...
        <el-tab-pane label="动态参数" name="many">
          ...
          <!-- 动态参数表格 -->
          <el-table :data="manyTableData" style="width: 100%" stripe>
            <!-- 展开行列 -->
        ...
        <el-tab-pane label="静态属性" name="only">
          ...
          <!-- 静态参数表格 -->
          <el-table :data="onlyTableData" style="width: 100%" stripe>
            <!-- 展开行列 -->
            <el-table-column type="expand">
              <template slot-scope="scope">
                <!-- 循环渲染 tag 标签 -->
                ...
                <!-- 按钮 -->
                <el-button v-else class="button-new-tag" circle plain @click="showInput(scope)">+ New Tag</el-button>
              </template>
            </el-table-column>
            <el-table-column type="index"></el-table-column>
    ...
    <!-- 添加参数的对话框 -->
    <el-dialog :modal-append-to-body="false" :title="activeName === 'many' ? '添加动态参数' : '添加静态属性'" :visible.sync="addDialogVisible" width="50%" @close="addDialogClosed">
      <!-- 添加参数的表单 -->
    ...
    <!-- 修改参数的对话框 -->
    <el-dialog :modal-append-to-body="false" :title="activeName === 'many' ? '修改动态参数' : '修改静态属性'" :visible.sync="editDialogVisible" width="50%" @close="editDialogClosed">
      <!-- 修改参数的表单 -->
