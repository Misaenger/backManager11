<template>
  <div>
    ...
    <el-card>
      ...
      <!-- 树形表格 -->
      <el-table :data="cateList" row-key="cat_id" :tree-props="{children: 'children', hasChildren: 'hasChildren'}" style="overflow:auto;max-height:750px">
        ...
        <el-table-column label="级别">
          <template slot-scope="scope">
            ...
            <span type="warning" v-else>三级</span>
          </template>
        </el-table-column>
    ...
    <!-- 编辑信息的对话框 -->
    <el-dialog title="编辑分类信息" :visible.sync="editDialogVisible" width="50%" @close="editDialogClosed" :modal-append-to-body="false">
      <!-- 编辑的表单 -->
  ...
  methods: {
    ...
    handleChange() {
      ...
      if (this.selectedParentCate.length === 0) {
        ...
        this.addForm.cat_pid = this.selectedParentCate[
